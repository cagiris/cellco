 ...
 *
 */
@GroupSequence({ ValidationCheckForEmpty.class, ValidationCheckForLength.class, ValidationCheckForPattern.class, UserProfileBean.class})
public class UserProfileBean extends AbstractBean implements ICRUDBean {
	...
	@Size (min = 6, max = 6, message = "Please enter a correct {min} digit postal code", groups = ValidationCheckForLength.class)

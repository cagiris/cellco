...
public interface IAttendenceReportingService {
	 ...
	 */
	IUserShiftInfo startUserShift(Long teamId, String userId)
			throws AttendenceReportingServiceException;

	/**
	 * This will be called when a user ends his shift.
	 */
	IUserShiftInfo endUserShift(String shiftId)
			throws AttendenceReportingServiceException;
	 ...
	 */
	ITeamShiftDetails createTeamShiftDetails(Long teamId, Date shiftStartTime,
			Date shiftEndTime, boolean autoExpire)
			throws AttendenceReportingServiceException;
	 ...
	 * before shiftEndTime and autoExpire is true.
	 */
	ITeamShiftDetails updateTeamShiftDetails(Long teamId, Date shiftStartTime,
			Date shiftEndTime, boolean autoExpire)
			throws AttendenceReportingServiceException;
	 ...
	 * logged out yet.
	 */
	List<? extends IUserShiftInfo> getCurrentUserShiftInfo(String userId)
			throws AttendenceReportingServiceException;

	/**
	 * This can be used by admin to query shift details for different users.
	 */
	List<? extends IUserShiftInfo> queryUserShiftInfo(List<String> userIds,
	 ...
	 * admin.
	 */
	IUserShiftInfo updateUserShiftInfo(String shiftId, Date shiftStartTime,
			Date shiftEndTime) throws AttendenceReportingServiceException;
